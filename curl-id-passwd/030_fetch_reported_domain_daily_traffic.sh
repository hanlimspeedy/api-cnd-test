...
OUTPUT_FILE="${OUT_DIR}/030_fetch_reported_domain_daily_traffic.json"
REQUEST_URL="https://openapi.cloudn.co.kr/cdnservice/statisticsapi/statistics/singledomain/traffic"
...
jq -e '.api_response.data.action_result.traffic | arrays' "${RESPONSE_FILE}" >/dev/null

echo "Traffic request succeeded. Response saved to ${OUTPUT_FILE}."
